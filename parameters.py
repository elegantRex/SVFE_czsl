...
# 添加参数，用于设置学习率、数据集、权重衰减、clip模型类型、epochs、epoch_start、训练batch_size、评估batch_size、fusion、context_length、attr_dropout、save_path、save_every_n、save_model、load_model、seed、gradient_accumulation_steps、open_world、bias、topk、text_encoder_batch_size、threshold、threshold_trials
...
# 添加参数，用于设置是否使用开放世界设置、偏置、topk、文本编码器batch_size、阈值、阈值尝试次数
